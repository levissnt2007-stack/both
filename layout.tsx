...
.section-divider::before {
  ...
  max-width: 1200px;
  height: 1px;
  background: linear-gradient(90deg, transparent, rgba(120, 90, 60, 0.15), transparent);
...
.btn-green {
  ...
  color: white;
  box-shadow: 0 4px 14px 0 rgba(31, 122, 77, 0.25);
  transition: all 0.3s ease;
}

.btn-green:hover {
  background-color: var(--btn-green-hover);
  box-shadow: 0 6px 20px 0 rgba(31, 122, 77, 0.35);
